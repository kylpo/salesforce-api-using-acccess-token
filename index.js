...
exports.getMentionCompletionsForRecord = function getMentionCompletionsForRecord(connection, query, recordId, callback) {
    xhrWithAuth(callback, "GET", connection, API_PATH_PREFIX.concat("chatter/mentions/completions?contextId=" + recordId + "&q=" + encodeURIComponent(query)));
};
